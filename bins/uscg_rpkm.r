...
option_list <- list(
  ...
  make_option(c("--min_length","-m"),type = "numeric",default = 75,
	      help = "Set the minimum length required for filtering reads, the default is 75, but it is recommended to set this parameter to 140 if hydrogenases or hydrogen metabolism terminal enzymes are to be calculated."),
...
opt_parser = OptionParser(
  usage = "usage: gcompip rpkm ribo [options]",
